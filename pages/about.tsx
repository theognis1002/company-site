...
const Aboutus = () => {
    ...
    return (
        <div>
            <Head>
                <title>About | Arclite Technologies</title>
            </Head>
            ...
            <section className="relative pt-14 lg:pb-48 lg:pt-[100px]">
                ...
                <div className="bottom-0 ltr:right-0 rtl:left-0 lg:absolute" data-aos={isRtl ? 'fade-right' : 'fade-left'} data-aos-duration="1000">
                    <Image src="/assets/images/about-who-bg.png" alt="About" width={0} height={0} sizes="100vw" className="rtl:rotate-y-180 h-auto w-auto" />
                </div>
            </section>
                ...
                <div className="container relative z-[2] ltr:xl:pr-40 rtl:xl:pl-40">
                    <div className="lg:w-2/3">
                        <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                            <h6>How it works?</h6>
                            <h4>Here are 5 working steps to deliver results to our clients.</h4>
                        </div>
                ...
                <div className="container">
                    <div className="relative">
                        <div className="relative xl:inline-block" data-aos="fade-down" data-aos-duration="1000">
                            <Image src="/assets/images/stay-text.png" alt="Stay" width={0} height={0} sizes="100vw" className="left-1/2 mx-auto sm:absolute sm:-translate-x-1/2 h-auto w-auto" />
                            <Image src="/assets/images/updated-text.png" alt="Update" width={0} height={0} sizes="100vw" className="mx-auto sm:pt-4 xl:mx-0 h-auto w-auto" />
